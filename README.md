...
## 📌 Project Description  
This project demonstrates how to deploy a Node.js web application on an AWS EC2 instance running Linux.
It covers end-to-end deployment: server setup, dependencies, process management, and verifying availability via public IP + port. 
The goal is to showcase practical DevOps skills in cloud, Linux and runtime management.
...
Cloned application and installed dependencies

git clone https://github.com/sudhanshutiwarith9-commits/sample-node-app.git  
cd sample-node-app  
npm install  

Ran the application and tested
node index.js 
...
🌐 Deployment URL
http://<your-ec2-public-ip>:3000       <!-- My ec2 public ip 44.222.77.135   -->
